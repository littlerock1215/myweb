...
<![endif]-->
	<table align="center" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; width: 100%; max-width: 600px;border:1px solid #efefef" class="content">
		<tr>
			<td bgcolor="#0674e9" style="padding: 10px 20px; text-align:center;color: white; font-family: Arial, '微軟正黑體', 'Microsoft JhengHei', 'Adobe 繁黑體 Std B', '儷黑 Pro'; font-size: 20px; line-height: 20px;">
